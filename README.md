...
### **The Tech Behind It**
We used **Java Swing** for the entire interface. The most challenging part was probably the layout management, which was getting everything to stay in place using `GridBagLayout`, but it allowed us to build custom dialogs that look organized.
